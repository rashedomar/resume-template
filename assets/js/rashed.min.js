var Terminal = Terminal || function(cmdRequest, cmdResponse) {
    ...
    const LS_ME = [
        'about.ro', 'contact.ro', 'education.ro', 'experience.ro', 'projects.ro', 'skills.ro', 'achievement.ro'
    ];
    ...
    cmdRequest_.addEventListener('keydown', function(e) {
        ...
        if (e.keyCode == 9) {
            ...
            switch (cmd) {
                case 'cat':
                    if (args[0].toLowerCase() == 'about.ro') {
                    ...
                    } else if (args[0].toLowerCase() == 'skills.ro') {
                    ...
                    } else if (args[0].toLowerCase() == 'education.ro') {
                    ...
                    } else if (args[0].toLowerCase() == 'contact.ro') {
                    ...
                    } else if (args[0].toLowerCase() == 'experience.ro') {
                ...
                case 'help':
                    ...
                    break;
                case 'ls':
                    output('<div class="">' + LS_ME.join('<br>') + '</div>');
                    break;
                case 'history':
